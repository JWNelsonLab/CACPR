---
title: "IRIsham1_2 Ambient RNA and Doublet Removal"
...
tod = Read10X_h5(here("Dataset", paste0(Sample, "_raw_feature_bc_matrix.h5"))) #Change
toc = Read10X_h5(here("Dataset", paste0(Sample, "_filtered_feature_bc_matrix.h5"))) #Change
sc = SoupChannel(tod,toc)

#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("Dataset", paste0(Sample, "_filtered_feature_bc_matrix.h5")))#Change 
...
seurat.obj.f <- subset(seurat.obj, subset = nFeature_RNA > 500)
...
FeaturePlot(seurat.obj.f, features = c("Lrp2"))

VlnPlot(CACPR_Combined, features = c("nFeature_RNA"), group.by = "class.sample")
...
Increasing expected number of doublets manually because extopic Lrp2 expression. 
...
FeaturePlot(seurat.obj.f, features = c("Lrp2"))
FeaturePlot(seurat.obj.f_singlets, features = c("Lrp2"))
...
saveRDS(seurat.obj.f_singlets, here("Output", paste0(Sample, ".rds"))) #Change
